...
var start_experiment_procedure = {
  ...
  "<p>左右の長方形の垂直方向の長さが同じ長さに見える場合でも、どちらが長く見えるか無理矢理判断して回答してください。<br/><br/>"+
  "スペースキーを押すと始まります。"+
  "</p>"
};
...
var finish_experiment_procedure = {
  ...
  on_start: function(trial) {
    ...
    trial.stimulus = '<p>実験終了です。</p><p>W・M-vertical.csvというファイル名のデータファイルが自動的にダウンロードされています。Excelで開けるので確認してください。</p>'+
    ...
    dt.localSave('csv', 'W・M-vertical.csv');    
  }
};
